...
//Offensive Spells: Organized by spell levels (Please follow this!)
...
/datum/spell_node/chill_touch //zizian. Retheme.
	name = "Chill Touch"
...
//Mana Upgrades?  (talk with aberra to see if this makes  sense)
...
/datum/spell_node/gib //if you remove this I will shoot you
