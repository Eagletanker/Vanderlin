...
/datum/outfit/job/bandit/roguemage/pre_equip(mob/living/carbon/human/H)
	...
	if(!(H.patron == /datum/patron/inhumen/zizo))		//Magic lore-wise is either Noc or Zizo. This class was cast out from the academy, so it's definitely not Noc. They don't get a spellbook either cause of it, BECAUSE THEY DONT HAVE A FUCKING DEGREE
	...
	backpack_contents = list(/obj/item/needle/thorn = 1, /obj/item/natural/cloth = 1, /obj/item/clothing/face/spectacles/sglasses, /obj/item/chalk = 1,)
	...
	ADD_TRAIT(H, TRAIT_ARCYNE_STUDENT, TRAIT_GENERIC) //todo, special version that allows them some combat shit
