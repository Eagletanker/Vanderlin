...
/datum/outfit/job/magician/pre_equip(mob/living/carbon/human/H)
	...
	beltr = /obj/item/storage/magebag/full
	...
	if(!(H.patron == /datum/patron/divine/noc || /datum/patron/inhumen/zizo)) //intentional. This means it's a gamble between Noc or Zizo if your not one already. Don't fucking change this.
